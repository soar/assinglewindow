...
Эта библиотека DLL AsSingleWindow создана автоматически с помощью 
мастера приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения AsSingleWindow.


AsSingleWindow.vcxproj
...
AsSingleWindow.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем AsSingleWindow.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.

...
/**
 * ѕоиск окна в списке
 * возвращаетс€ указатель на структуру с информацией
 */
...
/**
 * ѕоиск окна в списке
 * возвращаетс€ реверсный итератор
 */
...
/**
 * ƒобавление окна в список окон и выставление всех начальных значений
 * здесь же выставл€етс€ хук на wndProc
 */
...
/**
 * ”становка стартовых координат и размера окна
 * базируетс€ на основе координат последнего окна в списке
 */
...
/**
 * ѕеремещение и ресайз всех окон списка
 * hWnd - окно-источник событи€ перемещени€/ресайза
 */
void allWindowsMoveAndSizeWithBase(HWND hWnd)
{
    ...
    // ѕросмотр окон от текущего до конца
    ...
    // ѕросмотр окон от текущего до начала
